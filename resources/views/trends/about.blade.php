...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-7">
            <div class="card about-card p-5 text-center">
                <h2 class="fw-bold">Tentang Pembuat</h2>
                <p class="text-muted">Membangun jembatan informasi yang bersih.</p>
                ...
                <hr class="my-4">
                <p class="text-start">Platform Z dikembangkan untuk solusi informasi publik...</p>
            </div>
        </div>
    </div>
</div>
